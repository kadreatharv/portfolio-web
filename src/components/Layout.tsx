  ...
  return (
    <>
      ...
      <div style={{
        ...
        fontSize: '0.7rem', letterSpacing: '3px', opacity: 0.6, zIndex: 100, fontWeight: 600, mixBlendMode: 'difference'
      }}>
      ...
      <aside style={{
        ...
        <a href="https://github.com/kadreatharv" target="_blank" rel="noreferrer" style={{ fontSize: '1.5rem' }}><FaGithub /></a>
        <a href="https://linkedin.com/in/atharv-kadre-01485b27b" target="_blank" rel="noreferrer" style={{ fontSize: '1.5rem' }}><FaLinkedin /></a>
        <a href="https://x.com/Kadreatharv" target="_blank" rel="noreferrer" style={{ fontSize: '1.5rem' }}><FaXTwitter /></a>
        <a href="https://www.instagram.com/kadre_athxrv?igsh=aGZ1czlqZGV0aXYy" target="_blank" rel="noreferrer" style={{ fontSize: '1.5rem' }}><FaInstagram /></a>
      </aside>
